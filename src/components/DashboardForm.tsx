...
export function DashboardForm({ profile }: DashboardFormProps) {
  ...
  function handlePhotoChange(e: ChangeEvent<HTMLInputElement>) {
    ...
    if (!file) return;
    // Foto belum langsung dipakai - buka modal crop dulu supaya user
    // bisa menyesuaikan posisi/zoom sebelum benar-benar diupload.
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="hidden"
            />
            <p className="mt-1 text-xs text-kreova-muted/70">
              JPG/PNG - bisa di-crop dulu sebelum diunggah.
            </p>
          </div>
        </div>
